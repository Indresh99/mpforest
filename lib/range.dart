...
class _RangeState extends State<Range> {
  ...
  List<RangeModel> _notes = List<RangeModel>();
  List<RangeModel> _notesForDisplay = List<RangeModel>();


  List data;
  Future<List<RangeModel>> loadJsonData() async{
    var jsonText = await rootBundle.loadString('assests/RangeJson.json');
    var notes = List<RangeModel>();

    data = json.decode(jsonText);

    for(var not in data){
      notes.add(RangeModel.fromJson(not));
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(_notesForDisplay[index].range_EName, style: TextStyle(
                  fontSize: 22,
              ...
              /*Padding(
                padding: EdgeInsets.all(6),
                child: Text(_notesForDisplay[index].range_HName, style: TextStyle(
                  fontSize: 22,
                  fontWeight: FontWeight.bold,
                ),),
              ),
          ...
          setState(() {
            if(text.isEmpty) {
              ...
              _notesForDisplay = _notes.where((note) {
                var tile = note.range_EName.toLowerCase();
      ...
      return Container(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ListTile(
                title: Text("Range: "+_notesForDisplay[index].range_EName, style: TextStyle(
                    fontFamily: 'Times',
                    fontSize: 22,
                    color: Colors.white
                ),),
              ...
              ListTile(
                title: Text("Range: "+_notesForDisplay[index].range_HName, style: TextStyle(
                    fontFamily: 'Times',
                    fontSize: 22,
                    color: Colors.white
                ),),
